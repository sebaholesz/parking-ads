...
namespace ParkingAdsApi.ApiClients.AdClient
{
    ...
    public partial class AdClient 
    {
        ...
        public AdClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException("Either bad type or value were provided for the \'count\' query parameter.", status_, responseText_, headers_, null);
                        }
                        else
                        {
